...
pub const OpenGLRenderTarget = struct {
    ...
    pub fn start(_: OpenGLRenderTarget, _: *const context.OpenGLContext) void {
        gl.clearColor(0, 0, 0, 1);
        gl.clear(gl.COLOR_BUFFER_BIT | gl.DEPTH_BUFFER_BIT);
    }

    pub fn render(self: OpenGLRenderTarget, _: *const context.OpenGLContext, pipeline: OpenGLPipeline, buffer: OpenGLVertexBuffer) void {
    ...
    pub fn end(_: OpenGLRenderTarget, _: *const context.OpenGLContext) void {}
    pub fn submit(_: OpenGLRenderTarget, _: *const context.OpenGLContext) void {}
