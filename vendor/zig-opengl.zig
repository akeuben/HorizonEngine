...
pub fn build_zig_opengl(b: *std.Build, target: std.Build.ResolvedTarget, optimize: std.builtin.OptimizeMode, options: ZigOpenGLOptions) *std.Build.Module {
    ...
    const zig_opengl = b.addModule("zig-opengl", .{
